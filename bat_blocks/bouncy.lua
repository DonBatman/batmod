...
core.register_node("bat_blocks:bat_bounce", {
	description = "Bat Bounce",
	drawtype = "normal",
	tiles = {"bat_bounce.png"},
	paramtype = "light",
	groups = {cracky = 3, bouncy = 100,  fall_damage_add_percent = -1000},
...
core.register_node("bat_blocks:bat_bounce_not", {
...
core.register_craftitem("bat_blocks:bat_glue", {
...
core.register_craftitem("bat_blocks:bat_rubber_raw", {
...
core.register_craftitem("bat_blocks:bat_rubber_sheet", {
