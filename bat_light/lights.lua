...
minetest.register_node("bat_light:bat_light", {
	...
	node_box = {
		type = "fixed",
		fixed = {
			{-0.125, -0.25, 0.3125, 0.125, 0.25, 0.5}, -- NodeBox1
			{-0.5, -0.0625, 0.3125, 0.5, 0.0625, 0.5}, -- NodeBox2
			{-0.5, -0.25, 0.3125, -0.375, 0.25, 0.5}, -- NodeBox3
			{0.375, -0.3125, 0.3125, 0.5, 0.25, 0.5}, -- NodeBox4
			{-0.4375, 0.25, 0.3125, -0.3125, 0.375, 0.5}, -- NodeBox5
			{-0.4375, -0.375, 0.3125, -0.3125, -0.25, 0.5}, -- NodeBox6
			{0.3125, 0.25, 0.3125, 0.4375, 0.375, 0.5}, -- NodeBox7
			{0.3125, -0.375, 0.3125, 0.4375, -0.25, 0.5}, -- NodeBox8
			{-0.0625, -0.375, 0.3125, 0.0625, -0.25, 0.5}, -- NodeBox9
			{-0.125, 0.25, 0.3125, -0.0625, 0.375, 0.5}, -- NodeBox10
			{0.0625, 0.25, 0.3125, 0.125, 0.375, 0.5}, -- NodeBox12
		}
	}
})
